...
async function initHome() {
  ...
  const createQuestionBtn = document.getElementById("createQuestionBtn"); // *** Nuevo botón ***
  ...
  // *** CORRECCIÓN: Lógica para el nuevo botón ***
  createQuestionBtn.addEventListener("click", () => {
      // Limpiamos la selección para que el editor sepa que debe crear una nueva pregunta.
...
async function initRevision(){
    ...
    try {
        const me = await api("/profesores/me");
        // *** CORRECCIÓN: Mostrar foto de perfil en el header ***
    ...
    async function renderCurrent() {
        ...
        try {
            ...
            autorCargo.textContent = pr.cargo || pr.titulo || "";
